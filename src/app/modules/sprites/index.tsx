  ...
  return (
    ...
    >
      ...
      <Path
        ...
        stroke="#000"
      />
      <Path d="M 11.5,30 C 17,27 27,27 32.5,30" fill="none" stroke="#000" />
      <Path
        d="M 11.5,33.5 C 17,30.5 27,30.5 32.5,33.5"
        fill="none"
        stroke="#000"
      />
      <Path d="M 11.5,37 C 17,34 27,34 32.5,37" fill="none" stroke="#000" />
    </G>
  );
}
...
const Piece = (props: { name: keyof typeof pieces } & SvgProps) => {
  return <Svg width='100%' height='100%' viewBox="0 0 50 50" {...props}>{pieces[props.name]()}</Svg>
}
